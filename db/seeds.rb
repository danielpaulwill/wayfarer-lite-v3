...
v2 = Event.create(location_id: volcano.id, name: "Through a thick layer of ash you see a hidden passage at the base of the volcano", description: "The second Volcano event.", is_complete: false)
