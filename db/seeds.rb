...
f1o3 = Option.create(event_id: f1.id, action: "Crush the animals skulls with your foot", result: "The third option of the first Forest event.", is_complete: false, restriction_type: nil, restriction_value: nil, restriction_operation: nil)

f2o1 = Option.create(event_id: f2.id, action: "Option 1", result: "The first option of the second Forest event.", is_complete: false, restriction_type: nil, restriction_value: nil, restriction_operation: nil)
f2o2 = Option.create(event_id: f2.id, action: "Option 2", result: "The second option of the second Forest event.", is_complete: false, restriction_type: nil, restriction_value: nil, restriction_operation: nil)
f3o1 = Option.create(event_id: f3.id, action: "Option 1", result: "The first option of the third Forest event.", is_complete: false, restriction_type: nil, restriction_value: nil, restriction_operation: nil)
f3o2 = Option.create(event_id: f3.id, action: "Option 2", result: "The second option of the third Forest event.", is_complete: false, restriction_type: nil, restriction_value: nil, restriction_operation: nil)
